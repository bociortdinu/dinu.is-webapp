<template>
  <div class="ghibliScene">
    <SceneSection id="Ghibli">
      <TextBlock>
        <p>
          One of my hobbies is going on hiking trips.
          <span class="-big -purple">
          I've already conquered the highest peak in Romania,
          </span>
    ...
    <SceneSection id="Ghibli3">
      <TextBlock>
        <p class="-big">
          ...
          <span class="-purple">cultivating ornamental plants and crafting various arrangements with them.</span
          >
        </p>
        <p>
          This hobby allows me to connect with nature and bring a touch of greenery and beauty into my living space.
        </p>
      </TextBlock>
    </SceneSection>
